...
const Header = () => {
    return (
      <div className="flex flex-col md:flex-row flex-wrap bg-indigo-700 rounded-lg px-6 md:px-10 lg:px-20 ">
        {/* --------- Header Left --------- */}
        ...
        <div className="md:w-1/2 relative">
          <img
            className="w-full md:absolute bottom-0 h-full object-cover rounded-lg"
